...
/**
 * Build the stateOverride array for previewing custom art via the V4 renderer.
 *
 * V4 checks V2 first, then V1. We set the desired hash on V1 and clear V2
 * so the renderer falls through to V1 and picks up our override.
 */
